...
const schema = Yup.object().shape({
    ...
    cpf: Yup.string().required(MessageInvalidRequest.required), /*TODO: adicionar validação de cpf*/
    birthday: Yup.string().required(MessageInvalidRequest.required), /*TODO: arrumar data de nascimento*/
