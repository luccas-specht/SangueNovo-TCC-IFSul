...
export class CreateAllTables1620430472976 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_institution" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "razao_social" character varying NOT NULL, "cep" character varying NOT NULL, "latitude" character varying NOT NULL, "longitude" character varying NOT NULL, "cnpj" character varying NOT NULL, "tb_user_fk" uuid, CONSTRAINT "UQ_259a88abe9e751f595a99e836d3" UNIQUE ("cnpj"), CONSTRAINT "REL_d23ab5202773704b99539e5f8d" UNIQUE ("tb_user_fk"), CONSTRAINT "PK_ca01d7e8e4b324993beba935885" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "tb_scheduling" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "donatitonId" uuid, "institutionId" uuid, CONSTRAINT "PK_da129bb46168f1c5d9329b549a6" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "tb_donation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "campaignId" uuid, "donatorId" uuid, CONSTRAINT "PK_8394e1eb4761c2442917a4a876a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_campaign" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "avatar" character varying, "typeBlood" "tb_campaign_typeblood_enum" NOT NULL DEFAULT 'A+', "priority" "tb_campaign_priority_enum" NOT NULL DEFAULT 'Baixa', "available_date" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "institutionId" uuid, CONSTRAINT "REL_0f05ad6d2e3bc0758c08c93891" UNIQUE ("institutionId"), CONSTRAINT "PK_db65ab6f801c975e3f6937bb6bb" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
