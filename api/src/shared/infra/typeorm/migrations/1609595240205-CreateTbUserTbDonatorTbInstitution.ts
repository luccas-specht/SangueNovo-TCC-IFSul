...
export class CreateTbUserTbDonatorTbInstitution1609595240205 implements MigrationInterface {
    name = 'CreateTbUserTbDonatorTbInstitution1609595240205'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tb_donator" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "birthday" date NOT NULL, "cpf" character varying NOT NULL, "tbUserFkId" uuid, CONSTRAINT "REL_e3a1f19716356dc1e32cebf4f1" UNIQUE ("tbUserFkId"), CONSTRAINT "PK_0a69da6ca4a8b4dfcafc2a6510c" PRIMARY KEY ("id"))`);
